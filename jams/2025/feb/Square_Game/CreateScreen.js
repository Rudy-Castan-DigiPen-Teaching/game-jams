class CreateScreen {
  ...
  Setup() {
    if (this.editor) this.editor.teardown();
  ...
  Draw() {
    if (this.isEditor) this.editor.draw();
    else {
  ...
  OnKeyPressed() {
    if (!this.isEditor) this.platformer.keyPressed();
  }

  OnKeyReleased() {
    if (this.isEditor) this.editor.keyReleased();
    if (key === "p") {
      if (this.isEditor) {
  ...
  OnMousePressed() {
    if (this.isEditor) this.editor.mousePressed();
  }

  OnMouseDragged() {
    if (this.isEditor) this.editor.mouseDragged();
  }
}
