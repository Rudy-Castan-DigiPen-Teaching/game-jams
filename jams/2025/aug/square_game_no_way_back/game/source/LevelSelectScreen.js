class LevelSelectScreen
{
    constructor(levelNames)
    {
        ...
        {
            this.buttons.push(new Button(center_x, (i + 1) * this.buttonSpacing, levelNames[i]));
        }
    ...
    Update()
    {
        ...
        {
            this.scrollOffset = min((this.buttons.length - this.maxVisibleButtons) * this.buttonSpacing, this.scrollOffset + this.buttonSpacing);
        }
